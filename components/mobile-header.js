        ...
        >
            ...
            {!user && (
                <>
                    ...
                    <Box  style={{display:'flex',justifyContent:'justify-between', height: '3rem',paddingTop:5,paddingBottom:5}}>
                        ...
                        <span
                            ...
                            style={{
                                ...
                                fontSize:16,
                                height: 30,
                                background: 'linear-gradient(96deg, #F1CC64 7.88%, #B6C357 57.14%, #8ABC4A 93.08%)',
