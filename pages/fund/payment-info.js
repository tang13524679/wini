            ...
            <div className="bdWhite6 rounded-md my-4 p-4 capitalize">
              <div>
                <div className="flex justify-center items-center">
                  ...
                  <div className="clWhite">{t("bankTransfer")}</div>
                </div>
                <div className="flex justify-center items-end mt-4">
                  <div className="clWhite text-2xl">
                    {formatMoney(query.orderamount)}
                  </div>
                  <div className="clWhite30 ml-2">HKD</div>
                </div>
              </div>
              <div className="bgWhite2 rounded-md p-4 mt-4">
                ...
                <div className="flex justify-between items-center mt-2">
                  <div id="accountName">{query.accountname}</div>
                  <div
                    className="btnText copy-btn"
                ...
                <div className="flex justify-between items-center mt-2">
                  <div id="gameAccount">{user?.loginaccount}</div>
                  <div
                    className="btnText copy-btn"
              ...
              <div className="text-center mt-4">{t("fillInTips", "msg")}</div>
              <div
