...
const advantages = [
  ...
  },
  {
    ...
    desc_zh: "游戏，真人，体育，捕鱼，电子竞技，彩票。 和提供更多产品可选择",
  },
];
...
export default function HomePage() {
  ...
  return (
    <MainLayout>
          ...
          >
            <div
              style={{
                ...
                background:
                  "linear-gradient(91deg, #6E6AF5 20.09%, #7F3CE3 61%",
      ...
      <Box p={2} style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
        <div
          style={{
            display: "flex",
            alignItems: "center",
      ...
      <Box p={2} style={{ display: "flex", justifyContent: "space-between" }}>
        ...
        <img
          style={{ height: "5rem" }}
          src={`${"/assets/home/xukezheng1.png"}?&fit=crop&auto=format`}
        ></img>
        <img
          style={{ height: "5rem", marginLeft: "1rem", marginRight: "1rem" }}
          src={`${"/assets/home/xukezheng1.png"}?&fit=crop&auto=format`}
        ></img>
        <div style={{ fontSize: "1.5rem" }}>
          WIN品牌，由克拉索政府所 发放牌照并由库拉索博彩委
          员会监管（拍照号事：N.V #1168/JAZ）
        </div>
      </Box>
      <Box
        p={2}
      ...
      >
        ...
        <div style={{ fontSize: "1.5rem" }}>责任博彩</div>
      </Box>
      <Box
        p={2}
        style={{
