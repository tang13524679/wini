...
export default function RedEnvelopePage() {
    ...
    const { data: topList } = useSWR('/api/v1/ActivityNationalDay/topPhuHao');
    ...
    return (
        <div className={styles.container}>
                ...
                <div className="px-2">
                    <div className="sec relative mt-8 pb-4">
                        ...
                        <div className="overflow-auto" style={{ height: 160 }}>
                            <div className="grid grid-cols-1 sm:grid-cols-2 pl-6">
                                {(topList?.info && topList.info instanceof Array ) &&
                                    topList.info.map((item, index) => (
                                        <div
                                            key={index}
                                            className="flex gap-1 items-center rank"
                                        >
                                            <div className="index">
                                                {index + 1}
                                            </div>
                    ...
                    <div className="sec relative mt-12">
                        ...
                        <div className="p-4 text-white">
                            ...
                            <p className="py-4">
                                Toàn bộ thành viên của WIN1khi nạp tiền từ
                                2,000,000 trở lên sẽ nhận được 1 lần phong bao
                                lì xì. Với khuyến mãi tiền thưởng này, WIN1hy
                                vọng sẽ đem đến nhiều may mắn cho khách hàng.
                            </p>
                            <div className="flex items-center gap-2 mt-2">
                                <div className="star"></div>
                                <div className="yellow">
                            ...
                            <ul className="pl-8">
                                <li>
                                    Phương thức tham gia: thành viên bấm vào
                                    đường link trên web để tham gia sự kiện này.
                                </li>
                                <li>ố lần tham gia mỗi ngày tối đa 3 lần</li>
                                <li>
                                    Khuyến mãi tiền thưởng cần đạt 5 vòng cược
                                    tại hợp lệ ( tiền khuyến mãi nhận được
                                    38,000 nhân với 3 vòng cược = 114,000 cược
                                    hợp lệ rút tiền )
                                </li>
                                <li>
                                    Thành viên không điền đầy đủ thông tin cá
                                    nhân như ( Số điện thoại di động, email, họ
                                    tên, tài khoản ngân hàng) sẽ không đủ điều
                                    kiện đăng ký tham gia.
                                </li>
                                <li>
                                    Bất cứ cá nhân hay tập thể nào có hành vi
                                    gian lận hoặc lạm dụng để giành thắng lợi,
                                    WIN1có quyền hủy hoặc thu hồi tiền thưởng và
                                    đóng băng tài khoản thành viên{' '}
                                </li>
                                <li>
                                    WIN1chỉ tính các vé cược có kết quả thắng
                                    hoặc thua. Tất cả các vé cược hòa, rút tiền
                                    sớm, cược hủy,v.v đều sẽ không được tính là
                                    cược hợp lệ. Kết quả các vé cược nửa thắng,
                                    nửa thua và nửa cược sẽ chỉ tính một nửa số
                                    vòng cược hợp lệ
                                </li>
                                <li>
                                    WIN1có toàn quyền thực hiện , sửa đổi và
                                    quyết định cuối cùng trong hoạt động này mà
                                    không cần thông báo trước
                                </li>
                                <li>
                                    Hoạt động khuyến mãi này phải tuân thủ theo
                                    “ Điều khoản và điều kiện chung” của GG8.
                                </li>
                            </ul>
                        </div>
                        <img
            ...
            ></div>
            {model.isModel && (
                <Model setModel={setModel}>{model.content}</Model>
            )}
        </div>
    );
}
