...
export default function BankCardPage() {
  ...
  return (
    <InnerPageLayout>
      <Head>
        <title>Add Bank Card - WIN1</title>
      </Head>
      <div className="sm:px-4">
        <div className="bgInnerPage">
          <NavBar title={t("Addbankcard")} />
                ...
                <Form
                  ...
                  onFinish={async (values) => {
                    requestApi(
                      ...
                      async () => {
                        console.log(values);
                        values.openningbank = openningbank;
                        checker.isNumber(values.paymentaccount);
                        if (lang !== "zh") {
                          checker.isSpaceName(values.accountname);
                        }
                        await userApi.addUBankCard(values);
